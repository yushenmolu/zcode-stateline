...
rem ============================================================
rem Step 1/3: copy project files into the plugin cache
rem ============================================================
if "%DRY%"=="1" (
    ...
    echo [install] Step 1/3: copy done.
)
echo.

rem ============================================================
rem Step 2/3: register the plugin in installed_plugins.json
rem ============================================================
if "%DRY%"=="1" (
    echo [DRY] Step 2/3: would update %IP_JSON%
    ...
    echo [install] Step 2/3: updating installed_plugins.json ...
...
rem ============================================================
rem Step 3/3: enable the plugin in config.json
rem ============================================================
if "%DRY%"=="1" (
    echo [DRY] Step 3/3: would update %CFG_JSON%
    echo [DRY]   - back it up to config.json.bak-^<timestamp^>
    echo [DRY]   - set plugins.enabledPlugins["zcode-token-stats@local"] = true
) else (
    echo [install] Step 3/3: enabling plugin in config.json ...
